...
/*
GET: 
http://localhost/ums/rest/rest-subject.php/subjects
GET: 
http://localhost/ums/rest/rest-subject.php/subjects/TIF20833
...
DELETE
http://localhost/ums/rest/rest-subject.php/subjects/UMS99999
...
switch($verb) {
	...
	case 'DELETE':
		$id = $url_pieces[2];
		$storage->remove($id);
		header("Location: http://localhost/ums/rest/rest-subject.php/subjects", null, 204);
		exit;
		break;
	default: 
