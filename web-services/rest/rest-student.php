...
/*
GET: 
http://localhost/ums/rest/rest-student.php/students
GET: 
http://localhost/ums/rest/rest-student.php/students/l200124021
...
DELETE
http://localhost/ums/rest/rest-student.php/students/l200184029
...
switch($verb) {
	...
	case 'DELETE':
		$id = $url_pieces[2];
		$storage->remove($id);
		header("Location: http://localhost/ums/rest/rest-student.php/students", null, 204);
		exit;
		break;
	default: 
